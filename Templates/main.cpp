...
int main()
{
    ...
    std::cout << add<double>(1.5, 1) << std::endl; // 2.5 – type specified
    ...
    std::cout << std::boolalpha << equal(a, 1) << std::endl;                        // FALSE – type specified + not specialized for float (floating point comparison!)
    return 0;
}